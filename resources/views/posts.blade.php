                ...
                @foreach($posts as $post)
                    <div class="col-md-3 my-4">
                        <div class="card shadow card-mostsell cursor border p-2"
                            ...
                            <img onclick="window.location.href='{{route('post.details',$post->slug)}}'"  src="/storage/uploads/{{$post->image}}" class="card-img-top" alt="..." style="width:100%;border-top-left-radius:25px;width:100%;border-top-right-radius:25px">
                            <div class="card-body">
